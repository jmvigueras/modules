locals {
  ...
  prefix                   = "demo-hub-spoke-sdn" // prefix added to all resources created
  ...
  hubs_fgcp = [for hub in local.hub :
    {
      ...
      external_ip       = hub["vpn_port"] == "public" ? module.fgt_hub_vnet.fgt-active-public-ip : module.fgt_hub_vnet.fgt-active-ni_ips["private"]
