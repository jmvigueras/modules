...
module "fgt_hub_config" {
  ...
  cluster_pip          = module.fgt_hub_vnet.fgt-active-public-name
  fgt-active-ni_names  = module.fgt_hub_vnet.fgt-active-ni_names
  fgt-passive-ni_names = module.fgt_hub_vnet.fgt-passive-ni_names
  # -
