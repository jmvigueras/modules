...
module "vwan" {
  ...
  vnet_connection        = module.vhub_vnet-spoke.vnet_ids
...
module "fgt_hub_vnet-spoke" {
  ...
  vnet-spoke_cidrs = local.hub_vnet-spoke_cidrs
...
module "rs" {
  ...
  subnet_ids   = module.fgt_hub_vnet-spoke.subnet_ids["routeserver"]
...
module "vm_fgt_hub_vnet-spoke" {
  ...
  vm_ni_ids = [
    module.fgt_hub_vnet-spoke.ni_ids["subnet1"][0]
  ]
}
...
module "vm_vhub_vnet-spoke" {
  ...
  vm_ni_ids = [
    module.vhub_vnet-spoke.ni_ids["subnet1"][0]
  ]
}
