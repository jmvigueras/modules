# Forigate cluster deployment in 2 AZ and FortiManager and FortiAnalyzer
## Introduction
...
- FortiManager instance in AZ1 with public and private network interface (last version and PAYG by default).
- FortiAnalyzer instance in AZ1 with public and private network interface (last version and PAYG by default).
