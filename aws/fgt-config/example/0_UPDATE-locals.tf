...
locals {
  subnet_active_cidrs = {
    ...
    tgw     = cidrsubnet(local.hub1[0]["cidr"], 4, 3)
    gwlb    = cidrsubnet(local.hub1[0]["cidr"], 4, 4)
  }
  subnet_passive_cidrs = {
    mgmt    = cidrsubnet(local.hub1[0]["cidr"], 4, 8)
    public  = cidrsubnet(local.hub1[0]["cidr"], 4, 9)
    private = cidrsubnet(local.hub1[0]["cidr"], 4, 10)
    tgw     = cidrsubnet(local.hub1[0]["cidr"], 4, 11)
    gwlb    = cidrsubnet(local.hub1[0]["cidr"], 4, 12)
  }
  fgt-active-ni_ips = {
